...
const METHODOLOGY_TEMPLATES: Record<string, Record<string, unknown>> = {
  comparable_companies: {
    ...
    peer_companies: ["company1", "company2"],
  },
  last_round_market_adjusted: {
    last_post_money_usd: 500_000_000,
  ...
  last_round_multiple_ratchet: {
    last_post_money_usd: 500_000_000,
    last_round_date: "2023-01-01",
    sector_current_multiple: 8.0,
    sector_at_round_multiple: 12.0,
  },
  direct_valuation: {
    evidence_signals: [],
  },
  scorecard: {
    base_valuation_usd: 2_000_000,
    team_score: 0.8,
    opportunity_score: 0.7,
    product_score: 0.75,
    competition_score: 0.6,
    marketing_score: 0.7,
    need_funding_score: 0.8,
  },
  berkus: {
    basic_value_usd: 500_000,
    technology_value_usd: 500_000,
    execution_value_usd: 500_000,
    strategic_value_usd: 500_000,
    production_value_usd: 500_000,
  },
};
